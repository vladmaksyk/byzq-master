...
func (aq *AuthDataQ) EchoWriteQF(req *Value, replies []*WriteResponse) (reply *WriteResponse, quorum bool) {
	//fmt.Println("replies :", replies)
	if len(replies) <= aq.q {
		return nil, false
	}
...
func (aq *AuthDataQ) EchoEchoWriteQF(req *Value, replies []*WriteResponse) (reply *WriteResponse, quorum bool) {
	//fmt.Println("replies :", replies)
	if len(replies) <= aq.q {
		return nil, false
	}
